...
if __name__ == '__main__':
    ...
    for t in datasets2evaluate:
        test_dataset = preprocessingDataset2f(root_data=t, mode="valid",voxel=0.1)  # este valid es un test en realidad
        ...
        for x,saved in enumerate(models2evaluate):
            ...
            print("Accuracy o exactitud:", sum(all_accuracy) / len(all_accuracy))
            print("F1 score:", sum(all_f1score) / len(all_f1score))
            print("Recall score:", sum(all_recall) / len(all_recall))
            print("Precision score:", sum(all_precision) / len(all_precision))
            print("Miou score:", sum(all_miou) / len(all_miou))
